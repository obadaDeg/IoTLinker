"""
Space/Group Models
For organizing devices into groups (similar to ThingSpeak channels)
"""
...
class SpaceCreate(SpaceBase):
    """Model for creating a new space"""
...
class Space(SpaceBase):
    ...
    device_count: Optional[int] = Field(None, description="Number of devices in this space")
...
class SpaceListResponse(BaseModel):
    """Response model for list of spaces"""
    spaces: list[Space]
    total: int
    page: int
    page_size: int
